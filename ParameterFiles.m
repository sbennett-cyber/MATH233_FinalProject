...
poly(2).D = 1;
poly(2).r = 1;
net.CenterGaussianX = 7; %The Gaussian should be centered on the network
net.CenterGaussianY = 7.1415;
...
save('KinkedLinekd1V3_Net.mat', 'net')
save('KinkedLinekd1V3_poly.mat', 'poly')
clear all
close all
