...
SharedVertexY = [];
SharedWith = [1,2];
vertexX = [[0,100];[0,100]]; %Include one set of verticies for each row of Boundary
vertexY = [[0 100];[0 100]];%Include one set of verticies for each row of Boundary
plot([0,100],[0 100])
...
save('SL00100100kd1D4_Net.mat', 'net')
save('SL00100100kd1D4_poly.mat', 'poly')
...
save('SL00100100kd1D2_Net.mat', 'net')
save('SL00100100kd1D2_poly.mat', 'poly')
...
save('SL00100100kd1D8_Net.mat', 'net')
save('SL00100100kd1D8_poly.mat', 'poly')
...
close all
clc
poly(1).X = [0 0 100 100];
poly(1).Y = [0 50 50 0];
poly(1).D = 1;
poly(1).r = 1;

poly(2).X = [0 100 100 0];
poly(2).Y = [50 50 100 100];
poly(2).D = 1;
poly(2).r = 1;
net.CenterGaussianX = 50; %The Gaussian should be centered on the network
net.CenterGaussianY = 50;
...
SharedWith = [1,2];
vertexX = [[0,100];[0,100]]; %Include one set of verticies for each row of Boundary
vertexY = [[50 50];[50 50]];%Include one set of verticies for each row of Boundary
plot([0,100],[50 50])
...
save('SL00100100kd1V1_Net.mat', 'net')
save('SL00100100kd1V1_poly.mat', 'poly')
%% Setup Single Line kd = ka = 0
% Setup the verteces as a structure [coordX, coordY]
clear all
close all
...
save('SL00100100kd0_Net.mat', 'net')
save('SL00100100kd0_poly.mat', 'poly')
...
close all
clc
poly(1).X = [0 100 100 0];
poly(1).Y = [0 0 30.1415 30.1415];
poly(1).D = 1;
poly(1).r = 1;

poly(2).X = [0 100 100 0];
poly(2).Y = [30.1415 30.1415 100 100];
poly(2).D = 1;
poly(2).r = 1;
net.CenterGaussianX = 50; %The Gaussian should be centered on the network
net.CenterGaussianY = 40;
...
SharedWith = [1,2];
vertexX = [[0,100];[0,100]]; %Include one set of verticies for each row of Boundary
vertexY = [[30.1415 30.1415];[30.1415 30.1415]];%Include one set of verticies for each row of Boundary
plot([0,100],[30.1415 30.1415])
...
save('SL00100100kd1D1V1_Net.mat', 'net')
save('SL00100100kd1D1V1_poly.mat', 'poly')
% %% Setup Single Line kd = ka = 0
% % Setup the verteces as a structure [coordX, coordY]
% clear all
% close all
