...
% load('Ynet_Net.mat')
% load('Ynet_Poly.mat')
load('KinkedLinekd1V7_Net.mat')
load('KinkedLinekd1V7_poly.mat')
% load('StraightLinekd1V3_Net.mat')
% load('StraightLinekd1V3_poly.mat')
...
PntsInX = 41;
PntsInY = 41;
PntsLine = [81, 81, 0]; %This is a vector when the network has more than one channel
...
while i < Time
    ...
    Line1 = C.SolveNetwork(dt/2, Poly, NetworkMatrix ,Line, FieldIC, "ZeroDirichlet", "Plot"); %The dt must be the same as used in the matrix
